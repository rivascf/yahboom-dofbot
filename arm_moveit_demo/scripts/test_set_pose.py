...
if __name__ == '__main__':
    ...
    print("end:",end_effector_link)
    # 设置"down"为目标点
    yahboomcar.set_named_target("down")
    yahboomcar.go()
    sleep(0.5)
    '''end_effector_link = yahboomcar.get_end_effector_link()
    yahboomcar.shift_pose_target(1,0,end_effector_link)
    yahboomcar.go()'''
    sleep(0.5)
    # 创建位姿实例
    pos = PoseStamped()
    ...
    pos.pose.position.x = 0.438534#0.2
    pos.pose.position.y = 0.00145727#0.0
    pos.pose.position.z = 0.224613#0.2178
    # RPY的单位是角度值
    #roll = 90.0#-180
    #pitch = 45.0#45
    #yaw = 90.0#-180
    ...
    # 设置目标点
    yahboomcar.set_pose_target(pos,end_effector_link)
